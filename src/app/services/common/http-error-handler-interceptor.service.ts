        ...
        case HttpStatusCode.Unauthorized:
          this.userAuthService.refreshTokenLogin(localStorage.getItem("refreshToken"), (state) => {
            if(!state){
              ...
              if(url == "/products"){
                this.toastrService.message("Sepete ürün eklemeniz için oturum açmanız gerekiyor","Oturum Açınız", { messageType : ToastrMessageType.Warning, position : ToastrPosition.TopRight})
              }
              else{
